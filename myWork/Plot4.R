...
par(mfrow=c(2,2))
plot(data$a,data$Global_active_power,type = 'l',xlab='',ylab='Global Active Power')
plot(data$a,data$Voltage,type = 'l',xlab='datetime',ylab='Voltage')
...
plot(data$a,data$Global_active_power,type = 'h',xlab='datetime',ylab='Global_Reactive_Power')
par(mfrow=c(1,1))
dev.off()